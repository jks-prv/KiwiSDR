...
Copy this to the directory where you build the Kiwi server code.
...
In the file kiwi.config uncomment the value of RX_CFG for the configuration you
...
The make file in verilog/Makefile shows an example of this process.
