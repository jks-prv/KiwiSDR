...
/* web/kiwi/kiwi_ui.min.js (web/kiwi/kiwi_ui.js = Tue Mar 18 16:48:48 2025) */
...
function sd_backup_progress(){kiwi.sd_progress++;var secs=(kiwi.sd_progress%60).toFixed(0).leadingZeros(2);var mins=Math.floor(kiwi.sd_progress / 60).toFixed(0);w3_innerHTML('id-sd-backup-time',mins+':'+secs);if(kiwi.backup_size&&kiwi.backup_progress){if(kiwi.backup_size==1){w3_el('id-sd-progress-text').innerHTML=w3_el('id-sd-progress').style.width='100%';w3_innerHTML('id-sd-backup-msg','finalizing SD card');}else{var pct=((kiwi.backup_progress / kiwi.backup_size)*100).toFixed(0);if(pct==0)pct=1;if(pct<=99){w3_el('id-sd-progress-text').innerHTML=w3_el('id-sd-progress').style.width=pct+'%';}
w3_innerHTML('id-sd-backup-msg','copied '+kiwi.backup_progress.toFixed(0)+' of '+kiwi.backup_size.toFixed(0)+' MB');}}else
if(kiwi.sd_upgrade){var pct=((kiwi.sd_progress /(20*60))*100).toFixed(0);if(pct==0)pct=1;if(pct<=99){w3_el('id-sd-progress-text').innerHTML=w3_el('id-sd-progress').style.width=pct+'%';}}else{w3_innerHTML('id-sd-backup-msg',kiwi.sd_progress_msg);}}
