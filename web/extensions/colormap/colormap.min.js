...
/* web/extensions/colormap/colormap.min.js (web/extensions/colormap/colormap.js = Sat Aug  2 18:57:19 2025) */
...
function colormap_help(show){if(show){var s=w3_text('w3-medium w3-bold w3-text-aqua','Colormap Help')+
w3_div('w3-text-white','<br>Select a custom colormap from the <x1>colormap</x1> menu (e.g. "cust1") '+'then draw by mousing-down in large box. Try the other controls to see their effect. '+'Colormap changes are shown immediately in the waterfall.')
