...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Sun May 11 10:16:41 2025) */
...
var visOffset=divPanel.activeWidth-visIcon;if(rightSide){divVis.style.right=px(0);}else{var aw=divPanel.activeWidth;console_nv('init_panel_toggle',{panel},{visOffset},{divPanel},{aw},{visHoffset});divVis.style.left=px(visOffset+visHoffset);}
...
w3_el('id-button-slow-dev').style.background=(flags&wf.DDC1)?'cyan':'';data_arr_u8=new Uint8Array(data_raw,16);var bytes=data_arr_u8.length;if(need_maxmindb_update&&zoom_level==x_zoom_server){update_maxmindb_sliders();need_maxmindb_update=false;}
