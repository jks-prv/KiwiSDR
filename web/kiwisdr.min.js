...
function user_cb(obj){var id_prefix=kiwi.called_from_admin?'id-admin-user-':'id-monitor-user-';var host=kiwi_url_origin();obj.forEach(function(obj){var s,s1='',s2='',s3='';var i=obj.i;var name=obj.n;var freq=obj.f;var geoloc=obj.g;var ip=(isDefined(obj.a)&&obj.a!='')?(obj.a+', '):'';var mode=obj.m;var zoom=obj.z;var connected=obj.t;var remaining='';if(obj.rt){var t=(obj.rt==1)?' act':' 24h';remaining=' '+w3_text('w3-text-css-orange|vertical-align:bottom',obj.rs+t);}
...
/* web/kiwi/kiwi_util.min.js (web/kiwi/kiwi_util.js = Sun Mar  9 09:33:24 2025) */
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Sun Mar  9 10:22:08 2025) */
...
function w3_input_change(path,cb,from){var el=w3_el(path);if(el){var trace=w3_contains(el,'w3-trace');trace=1;if(trace)console.log('w3_input_change path='+path+' from='+from);if(cb){var cb_a=cb.split('|');if(isArg(from))cb_a.push(from);w3_call(cb_a[0],path,el.value,false,cb_a);if(from=='in')return;}
...
/* web/kiwi/ant_switch.min.js (web/kiwi/ant_switch.js = Wed Feb 19 11:42:05 2025) */
...
/* web/openwebrx/audio.min.js (web/openwebrx/audio.js = Wed Feb  5 19:59:00 2025) */
