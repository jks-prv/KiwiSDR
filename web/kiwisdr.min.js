...
/* web/extensions/ext.min.js (web/extensions/ext.js = Thu Jan  8 15:42:28 2026) */
...
/* web/kiwi/kiwi.min.js (web/kiwi/kiwi.js = Sun Jan 18 08:26:11 2026) */
...
/* web/kiwi/kiwi_util.min.js (web/kiwi/kiwi_util.js = Sun Jan 18 08:39:35 2026) */
...
version_maj=response_obj.maj;version_min=response_obj.min;kiwi.admin_save_pwd=response_obj.sp;var s='';kiwi_check_js_version.forEach(function(el){if(el.VERSION_MAJ!=version_maj||el.VERSION_MIN!=version_min){if(kiwi.kiwi_version_fail==false){s='Your browser is trying to use incorrect versions of the KiwiSDR Javascript files.<br>'+'Please clear your browser cache and try again.<br>'+'Or click the button below to continue anyway.<br><br>'+'v'+version_maj+'.'+version_min+': KiwiSDR server<br>';kiwi.kiwi_version_fail=true;}
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Fri Jan  9 15:19:45 2026) */
...
/* web/kiwi/kiwi_map.min.js (web/kiwi/kiwi_map.js = Sun Jan 18 08:38:35 2026) */
...
function kiwi_map_all_msg_cb(msg_a,ws){var kmap=ws.gen_cb_param;var cmd=msg_a[0];var param=isString(msg_a[1])?msg_a[1]:'';console.log('kiwi_map_all_msg_cb: cmd='+cmd+' param='+param);var reason='Connection failed';switch(cmd){case'badp':if(+param!=0){kmap.wf_conn_bad=true;}
...
w3_innerHTML(kmap.submit_status,'Waterfall preview: '+kmap.wf_id2);kmap.wf_ws=open_websocket('W/F',function(){kmap.preview_lines=0;kmap.wf_ws.send("SET auth t=kiwi");kmap.wf_ws.send("SERVER DE CLIENT openwebrx.js W/F");kmap.wf_ws.send("SET ident_user=WF_preview");kmap.wf_ws.send("SET send_dB=1");kmap.wf_ws.send('SET zoom='+zoom_level+' start='+x_bin);kmap.wf_ws.send("SET maxdb=0 mindb=-100");kmap.wf_ws.send("SET wf_speed=3");kmap.preview_timeo=setTimeout(function(){if(kmap.wf_ws)kmap.wf_ws.close();},10000);},kmap,null,kiwi_map_waterfall_add_queue,kiwi_map_wf_preview_error_cb,kiwi_map_waterfall_close,{url:kmap.wf_url_full,new_ts:true,qs:'',all_msg_cb:kiwi_map_all_msg_cb,gen_cb_param:kmap,trace:1});kmap.wf_conn_bad=false;kiwi.wf_preview_mode=true;}
function kiwi_map_wf_preview_error_cb(ev,ws){console.log('kiwi_map_wf_preview_error_cb..');console.log(ev);console.log(ws);console.log('..kiwi_map_wf_preview_error_cb');}
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Sun Jan 18 12:28:55 2026) */
