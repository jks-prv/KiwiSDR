...
/* web/extensions/ext.min.js (web/extensions/ext.js = Fri Feb  7 13:14:35 2025) */
...
function config_str_update(rx_chans,gps_chans,vmaj,vmin){kiwi_config_str='v'+vmaj+'.'+vmin+', D'+kiwi.debian_maj+'.'+kiwi.debian_min;w3_innerHTML('id-status-config',kiwi_config_str);kiwi_config_str_long='KiwiSDR '+kiwi.model+', v'+vmaj+'.'+vmin+', '+rx_chans+' SDR channels, '+gps_chans+' GPS channels';w3_innerHTML('id-msg-config',kiwi_config_str);}
...
/* web/kiwi/kiwi_util.min.js (web/kiwi/kiwi_util.js = Fri Feb  7 14:22:18 2025) */
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Fri Feb  7 09:14:15 2025) */
...
if(!el)return;if(opts['scanning']&&extint.scanning)return;var focus=0,select=0,blur=0;if(opts['mobile']&&kiwi_isMobile())blur=1;else focus=select=1;if(opts['blur'])blur=1;if(opts['focus_select'])focus=select=1;if(opts['focus_only']){focus=1;select=0;}
...
if(trace)console.log('ss='+el.selectionStart+' se='+el.selectionEnd+' tl='+el.textLength);if((el.selectionStart==el.selectionEnd&&el.selectionStart==el.textLength)||(el.selectionStart==0&&el.selectionEnd==el.textLength)||(el.value=='')){if(trace)console.log('w3_input_change...');w3_input_change(path,cb,'kd');}}else
...
/* web/kiwi/ant_switch.min.js (web/kiwi/ant_switch.js = Sat Feb  1 11:20:50 2025) */
